...
>
> 本项目仅供**个人求职使用**,不用于商业或中介用途(例如代表多个客户运行,或嵌入付费招聘产品中)。
...
这一步会用**你自己的浏览器登录状态**,以你本人身份登录 LinkedIn/Seek/Indeed/Jora/Fuse Recruitment/Synergie 等平台,并把职位提醒都指向第 5 步的 Gmail 邮箱。每一步真正的操作前,它都会先解释清楚并征求你的同意 —— 批准前请仔细看它说了什么。如果你不想用自动化方式,它也提供了完整的手动操作说明。
