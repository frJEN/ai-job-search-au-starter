...
The `site:` query templates in this file are the **WebSearch fallback** — for Seek/Indeed/Jora, any other portal without a CLI, company career pages, or when a CLI fails.
